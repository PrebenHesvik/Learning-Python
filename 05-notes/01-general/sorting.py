...
dictionary = {'name': 'Preben', 'job': 'web-development',
              'age': 36, 'language': 'Python'}
# <--- the sorted function sorts the dictionary keys
...
class Employee():
    ...
    # <--- this specifies how we want this class represented when we print it out to the screen.
    def __repr__(self):
